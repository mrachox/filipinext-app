<template>
  <!-- <Tutorial/> -->
  <div class="container">
  <span id="menu-btn" v-b-toggle.sidebar-1><b-icon icon="list"></b-icon></span>
  ...
  <div class="d-flex row main-content px-3 py-2">
    <div class="align-self-center my-5">
      <h1 class="placeholder" v-html="posts[11].title" style="text-align: initial;"></h1>
      <p>filipinextconference@gmail.com</p>
      <p><a href="https://instagram.com/filipinext">https://instagram.com/filipinext</a></p>
      <p><a href="https://twitter.com/filipinext">https://twitter.com/filipinext</a></p>
